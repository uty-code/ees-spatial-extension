...
public class MainController {
    ...
    private final com.ees.eval.service.DashboardService dashboardService;
    ...
    public String dashboard(Model model) {
        com.ees.eval.dto.DashboardStatsDTO stats = dashboardService.getDashboardStats();
        ...
        // 최신 등록 사원은 기존처럼 표시 (stats에 포함 안 됨)
